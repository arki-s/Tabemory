...
namespace Tabemory.Data.Migrations
{
    ...
    [Migration("20231024053551_dbcontextChanged")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Tabemory.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Tabemory.Models.Record", b =>
                {
            ...
            modelBuilder.Entity("Tabemory.Models.Review", b =>
                {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Tabemory.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Tabemory.Models.Review", b =>
                {
                    ...
                    b.HasOne("Tabemory.Models.Record", "Record")
                        .WithMany("Reviews")
